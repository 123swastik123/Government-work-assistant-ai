...
export function SkeletonCard() {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5 space-y-3 overflow-hidden">
      ...
      <div className="h-3 bg-gray-100 rounded-lg w-full shimmer" />
      <div className="h-3 bg-gray-100 rounded-lg w-2/3 shimmer" />
  ...
  return (
    <div className="space-y-2">
      {Array.from({ length: lines }).map((_, i) => (
        <div key={i}
          className="h-3 bg-gray-100 rounded-lg shimmer"
